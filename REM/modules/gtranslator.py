...
def totranslate(update: Update, context: CallbackContext):
    ...
    try:
        ...
        update.effective_message.reply_text("اللغة المطلوبة غير موجودة!")
    else:
        return


__help__ = """
  • `/tr` أو `/tl` (رمز اللغة) كرد على رسالة طويلة
  *مثال:*
    `/tr en`*:* يترجم شيئاً إلى الإنجليزية
    `/tr hi-en`*:* يترجم من الهندية إلى الإنجليزية
  """
