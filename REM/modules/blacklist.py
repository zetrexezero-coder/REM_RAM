...
__mod_name__ = "الكلمات المحظورة"

__help__ = """

  تُستخدم الكلمات المحظورة لمنع ذكر كلمات معينة في القروب. في كل مرة يُذكر أحد المحفزات، سيتم حذف الرسالة فوراً. من الجيد أحياناً دمج هذا مع فلاتر التحذير!

  *ملاحظة*: لا تنطبق الكلمات المحظورة على مشرفي القروب.

   • `/blacklist`*:* عرض الكلمات المحظورة الحالية.

  للمشرفين فقط:
   • `/addblacklist <الكلمات>`*:* إضافة كلمة محظورة. كل سطر يُعتبر كلمة واحدة، فاستخدام أسطر مختلفة يتيح إضافة عدة كلمات.
   • `/unblacklist <الكلمات>`*:* إزالة كلمات من القائمة المحظورة. يُطبَّق نفس منطق الأسطر هنا، فيمكنك إزالة عدة كلمات دفعة واحدة.
   • `/blacklistmode <off/del/warn/ban/kick/mute/tban/tmute>`*:* الإجراء المتخذ عند إرسال شخص كلمة محظورة.

  حظر الملصقات يُستخدم لمنع ملصقات معينة. عند إرسال ملصق محظور، سيتم حذف الرسالة فوراً.
  *ملاحظة:* لا ينطبق حظر الملصقات على مشرفي القروب
   • `/blsticker`*:* عرض الملصقات المحظورة حالياً
  *للمشرفين فقط:*
   • `/addblsticker <رابط الملصق>`*:* إضافة ملصق للقائمة المحظورة. يمكن إضافته بالرد على الملصق
   • `/unblsticker <رابط الملصق>`*:* إزالة ملصق من القائمة المحظورة. يُطبَّق نفس منطق الأسطر، فيمكنك حذف عدة ملصقات دفعة واحدة
   • `/rmblsticker <رابط الملصق>`*:* نفس الأمر السابق
   • `/blstickermode <delete/ban/tban/mute/tmute>`*:* تعيين الإجراء الافتراضي عند استخدام مستخدمين لملصقات محظورة
  ملاحظة:
   • `<رابط الملصق>` يمكن أن يكون `https://t.me/addstickers/<الملصق>` أو فقط `<الملصق>` أو الرد على رسالة الملصق
  """
