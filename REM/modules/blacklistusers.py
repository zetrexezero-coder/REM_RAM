...
def bl_user(update: Update, context: CallbackContext) -> str:
    ...
    if not user_id:
        message.reply_text("أشك أن هذا مستخدم.")
        return ""

    if user_id == bot.id:
        message.reply_text("كيف يمكنني العمل إذا كنت أتجاهل نفسي؟")
        return ""
    ...
    message.reply_text("سأتجاهل وجود هذا المستخدم!")
    log_message = (
        f"#BLACKLIST\n"
...
def unbl_user(update: Update, context: CallbackContext) -> str:
    ...
    if user_id == bot.id:
        message.reply_text("أنا دائماً ألاحظ نفسي.")
        return ""
    ...
    if sql.is_user_blacklisted(user_id):
        ...
        message.reply_text("لم أكن أتجاهله أصلاً!")
        return ""
