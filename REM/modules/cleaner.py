...
__help__ = """
  منظف النص الأزرق يحذف أي أوامر مزيفة يرسلها الأعضاء في قروبك.
   • `/cleanblue <on/off/yes/no>`*:* تنظيف الأوامر بعد إرسالها
   • `/ignoreblue <كلمة>`*:* منع التنظيف التلقائي للأمر
   • `/unignoreblue <كلمة>`*:* إزالة منع التنظيف التلقائي للأمر
   • `/listblue`*:* عرض قائمة الأوامر المسموح بها حالياً

   *الأوامر التالية مخصصة للكوارث فقط، لا يمكن للمشرفين استخدامها:*
   • `/gignoreblue <كلمة>`*:* تجاهل تنظيف النص الأزرق لكلمة محفوظة بشكل عام عبر Saitama.
   • `/ungignoreblue <كلمة>`*:* إزالة ذلك الأمر من قائمة التجاهل العامة
  """
