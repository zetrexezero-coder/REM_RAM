...
def import_data(update, context):
    ...
    if conn:
        ...
        if update.effective_message.chat.type == "private":
            update.effective_message.reply_text("هذا الأمر للمجموعات فقط!")
            return ""
...
__help__ = """
  ...
  *لمالك القروب فقط:*
   ...
   • /import: رد على ملف النسخة الاحتياطية لاستيراد أكبر قدر ممكن من البيانات، مما يسهّل النقل كثيراً!    لاحظ أن الملفات والصور لا يمكن استيرادها بسبب قيود تلغرام.

   • /export: تصدير بيانات القروب، وما سيتم تصديره هو: القوانين، الملاحظات (المستندات، الصور، الموسيقى، الفيديو، الصوت، الرسائل الصوتية، النصوص، الأزرار النصية) 
  """
